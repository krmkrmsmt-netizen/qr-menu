    ...
    <div style={styles.page}>
      ...
      <main style={styles.container}>
        <section style={styles.hero}>
          <div>
            ...
            <p style={styles.heroText}>
              Restoranınızın profesyonel dijital
              menüsünü dakikalar içinde oluşturun.
            </p>
          </div>
        ...
        <section style={styles.card}>
          ...
          <div style={styles.calorieHint}>
            💡 Fotoğraftan AI ile analiz edildiğinde
            kalori yaklaşık olarak hesaplanabilir.
          </div>
        ...
        >
          ...
          <div style={styles.calorieNotice}>
            🔥 Kalori değerleri yaklaşık değerlerdir.
            Gerçek değerler ürünün içeriğine ve
            porsiyonuna göre değişebilir.
          </div>
        </section>
